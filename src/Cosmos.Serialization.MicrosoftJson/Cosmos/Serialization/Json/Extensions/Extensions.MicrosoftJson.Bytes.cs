...
namespace Cosmos.Serialization.Json
{
    ...
    public static partial class MsJsonExtensions
    {
        ...
        {
            return MS.SerializeToBytes(obj, options);
        }
        ...
        {
            return MS.SerializeToBytesAsync(obj, options);
        }
        ...
        {
            return MS.DeserializeFromBytes<T>(data, options);
        }
        ...
        {
            return MS.DeserializeFromBytes(data, type, options);
        }
        ...
        {
            return MS.DeserializeFromBytesAsync<T>(data, options);
        }
        ...
        {
            return MS.DeserializeFromBytesAsync(data, type, options);
        }
    }
}