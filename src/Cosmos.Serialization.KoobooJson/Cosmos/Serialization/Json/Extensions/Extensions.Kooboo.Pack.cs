...
namespace Cosmos.Serialization.Json
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return K.PackAsync(obj, options);
        }
        ...
        {
            return K.PackAsync(obj, stream, options);
        }
        ...
        {
            return K.Unpack<T>(stream, options);
        }
        ...
        {
            return K.Unpack(stream, type, options);
        }
        ...
        {
            return await K.UnpackAsync<T>(stream, options);
        }
        ...
        {
            return await K.UnpackAsync(stream, type, options);
        }
    }
}