...
namespace Cosmos.Serialization.MessagePack
{
    ...
    public static partial class Extensions
    {
        ...
        {
            await N.PackAsync(obj, type, stream);
        }
        ...
        {
            return N.UnpackAsync(stream, type);
        }
    }
}