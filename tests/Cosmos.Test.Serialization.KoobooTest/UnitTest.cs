...
public class UnitTest
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToKoobooStream();
        var stream2 = new MemoryStream();
        model.KoobooPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.KoobooPackBy(model);

        var back1 = stream1.FromKoobooStream<NiceModel>();
        var back2 = stream2.FromKoobooStream<NiceModel>();
        var back3 = stream3.FromKoobooStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromKoobooStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromKoobooStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromKoobooStream(typeof(NiceModel));
