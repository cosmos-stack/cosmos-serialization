...
public class UnitTest
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToSharpYamlStream();
        ...
        var back1 = stream1.FromSharpYamlStream<NiceModel>();
        var back2 = stream2.FromSharpYamlStream<NiceModel>();
        var back3 = stream3.FromSharpYamlStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromSharpYamlStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromSharpYamlStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromSharpYamlStream(typeof(NiceModel));
    ...
    public void NonGenericStringTest()
    {
        var model = CreateNiceModel();
        var yaml = model.ToYaml();
        var back1 = (NiceModel)yaml.FromYaml(typeof(NiceModel));
