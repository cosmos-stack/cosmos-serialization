...
public class UnitTestAsync
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = await model.ToSharpYamlStreamAsync();
        var stream2 = new MemoryStream();
        await model.SharpYamlPackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.SharpYamlPackByAsync(model);

        var back1 = await stream1.FromSharpYamlStreamAsync<NiceModel>();
        var back2 = await stream2.FromSharpYamlStreamAsync<NiceModel>();
        var back3 = await stream3.FromSharpYamlStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromSharpYamlStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromSharpYamlStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromSharpYamlStreamAsync(typeof(NiceModel));
