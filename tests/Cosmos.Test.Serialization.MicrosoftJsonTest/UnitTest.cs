...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToMsJsonBytes();
        var backs = bytes.FromMsJsonBytes<NiceModel>();
    ...
    public void NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = model.ToMsJsonBytes();
        var backs = (NiceModel)bytes.FromMsJsonBytes(typeof(NiceModel));
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToMsJsonStream();
        var stream2 = new MemoryStream();
        model.MsJsonPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.MsJsonPackBy(model);

        var back1 = stream1.FromMsJsonStream<NiceModel>();
        var back2 = stream2.FromMsJsonStream<NiceModel>();
        var back3 = stream3.FromMsJsonStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromMsJsonStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromMsJsonStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromMsJsonStream(typeof(NiceModel));
    ...
    public void NonGenericStringTest()
    {
        var model = CreateNiceModel();
        var json1 = model.ToMsJson();
        var back1 = (NiceModel)json1.FromMsJson(typeof(NiceModel));
