...
public class JsonTestAsync
{
    ...
    public async Task BasicJsonTest()
    {
        ...
        var back2 = (NiceModel)await json1.FromMsJsonAsync(typeof(NiceModel));
    ...
    public async Task OptionalJsonTest()
    {
        ...
        var json1 = await model.ToMsJsonAsync(options);
        var back1 = await json1.FromMsJsonAsync<NiceModel>(options);
        var back2 = (NiceModel)await json1.FromMsJsonAsync(typeof(NiceModel), options);
