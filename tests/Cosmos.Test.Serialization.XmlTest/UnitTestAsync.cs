...
public class UnitTestAsync
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = await model.ToXmlStreamAsync();
        var stream2 = new MemoryStream();
        await model.XmlPackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.XmlPackByAsync(model);

        var back1 = await stream1.FromXmlStreamAsync<NiceModel>();
        var back2 = await stream2.FromXmlStreamAsync<NiceModel>();
        var back3 = await stream3.FromXmlStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromXmlStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromXmlStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromXmlStreamAsync(typeof(NiceModel));
