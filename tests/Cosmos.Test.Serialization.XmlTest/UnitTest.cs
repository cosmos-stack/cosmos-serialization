...
public class UnitTest
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToXmlStream();
        var stream2 = new MemoryStream();
        model.XmlPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.XmlPackBy(model);

        var back1 = stream1.FromXmlStream<NiceModel>();
        var back2 = stream2.FromXmlStream<NiceModel>();
        var back3 = stream3.FromXmlStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromXmlStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromXmlStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromXmlStream(typeof(NiceModel));
