...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToNewtonsoftBytes();
        var backs = bytes.FromNewtonsoftJsonBytes<NiceModel>();
    ...
    public void NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = model.ToNewtonsoftBytes();
        var backs = (NiceModel)bytes.FromNewtonsoftJsonBytes(typeof(NiceModel));
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToNewtonsoftStream();
        var stream2 = new MemoryStream();
        model.NewtonsoftPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.NewtonsoftPackBy(model);

        var back1 = stream1.FromNewtonsoftStream<NiceModel>();
        var back2 = stream2.FromNewtonsoftStream<NiceModel>();
        var back3 = stream3.FromNewtonsoftStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromNewtonsoftStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromNewtonsoftStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromNewtonsoftStream(typeof(NiceModel));
    ...
    public void NonGenericStringTest()
    {
        var model = CreateNiceModel();
        var json1 = model.ToNewtonsoftJson();
        var back1 = (NiceModel)json1.FromNewtonsoftJson(typeof(NiceModel));
