...
public class JsonTestAsync
{
    ...
    public async Task BasicJsonTest()
    {
        ...
        var back2 = (NiceModel)await json1.FromNewtonsoftJsonAsync(typeof(NiceModel));
    ...
    public async Task OptionalJsonTest()
    {
        ...
        var json1 = await model.ToNewtonsoftJsonAsync(options);
        var back1 = await json1.FromNewtonsoftJsonAsync<NiceModel>(options);
        var back2 = (NiceModel)await json1.FromNewtonsoftJsonAsync(typeof(NiceModel), options);
