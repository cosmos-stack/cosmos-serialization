...
public class UnitTestAsync
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = await model.ToLitStreamAsync();
        var stream2 = new MemoryStream();
        await model.LitPackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.LitPackByAsync(model);

        var back1 = await stream1.FromLitStreamAsync<NiceModel>();
        var back2 = await stream2.FromLitStreamAsync<NiceModel>();
        var back3 = await stream3.FromLitStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromLitStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromLitStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromLitStreamAsync(typeof(NiceModel));
