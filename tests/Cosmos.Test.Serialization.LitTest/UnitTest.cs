...
public class UnitTest
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToLitStream();
        var stream2 = new MemoryStream();
        model.LitPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.LitPackBy(model);

        var back1 = stream1.FromLitStream<NiceModel>();
        var back2 = stream2.FromLitStream<NiceModel>();
        var back3 = stream3.FromLitStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromLitStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromLitStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromLitStream(typeof(NiceModel));
