...
public class JsonTest
{
    ...
    public void BasicJsonTest()
    {
        ...
        var back2 = (NiceModel)json1.FromJilJson(typeof(NiceModel));
    ...
    public void OptionalJsonTest()
    {
        ...
        var json1 = model.ToJilJson(options);
        var back1 = json1.FromJilJson<NiceModel>(options);
        var back2 = (NiceModel)json1.FromJilJson(typeof(NiceModel), options);
