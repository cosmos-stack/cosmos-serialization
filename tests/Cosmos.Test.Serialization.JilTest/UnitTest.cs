...
public class UnitTest
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToJilStream();
        var stream2 = new MemoryStream();
        model.JilPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.JilPackBy(model);

        var back1 = stream1.FromJilStream<NiceModel>();
        var back2 = stream2.FromJilStream<NiceModel>();
        var back3 = stream3.FromJilStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromJilStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromJilStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromJilStream(typeof(NiceModel));
    ...
    {
        var model = CreateNiceModel();
        var json1 = model.ToJilJson();
        var back1 = json1.FromJilJson<NiceModel>();
    ...
    public void NonGenericStringTest()
    {
        var model = CreateNiceModel();
        var json1 = model.ToJilJson();
        var back1 = (NiceModel)json1.FromJilJson(typeof(NiceModel));
