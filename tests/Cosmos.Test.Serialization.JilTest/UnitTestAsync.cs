...
public class UnitTestAsync
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = await model.ToJilStreamAsync();
        var stream2 = new MemoryStream();
        await model.JilPackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.JilPackByAsync(model);

        var back1 = await stream1.FromJilStreamAsync<NiceModel>();
        var back2 = await stream2.FromJilStreamAsync<NiceModel>();
        var back3 = await stream3.FromJilStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromJilStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromJilStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromJilStreamAsync(typeof(NiceModel));
    ...
    public async Task NonGenericStringTest()
    {
        var model = CreateNiceModel();
        var json1 = await model.ToJilJsonAsync();
        var back1 = (NiceModel)await json1.FromJilJsonAsync(typeof(NiceModel));
