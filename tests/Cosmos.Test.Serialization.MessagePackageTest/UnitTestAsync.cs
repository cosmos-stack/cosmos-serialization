...
public class UnitTestAsync
{
    ...
    public async Task BytesTest()
    {
        ...
        var bytes = await model.ToMessagePackBytesAsync();
        var backs = await bytes.FromMessagePackBytesAsync<NiceModel>();
    ...
    public async Task NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = await model.ToMessagePackBytesAsync();
        var backs = (NiceModel)await bytes.FromMessagePackBytesAsync(typeof(NiceModel));
    ...
    public async Task StreamTest()
    {
        ...
        await model.MessagePackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.MessagePackByAsync(model);

        var back1 = await stream1.FromMessagePackStreamAsync<NiceModel>();
        var back2 = await stream2.FromMessagePackStreamAsync<NiceModel>();
        var back3 = await stream3.FromMessagePackStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromMessagePackStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromMessagePackStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromMessagePackStreamAsync(typeof(NiceModel));
