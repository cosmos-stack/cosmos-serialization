...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToMessagePackBytes();
        var backs = bytes.FromMessagePackBytes<NiceModel>();
    ...
    public void NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = model.ToMessagePackBytes();
        var backs = (NiceModel)bytes.FromMessagePackBytes(typeof(NiceModel));
    ...
    public void StreamTest()
    {
        ...
        model.MessagePackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.MessagePackBy(model);

        var back1 = stream1.FromMessagePackStream<NiceModel>();
        var back2 = stream2.FromMessagePackStream<NiceModel>();
        var back3 = stream3.FromMessagePackStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromMessagePackStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromMessagePackStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromMessagePackStream(typeof(NiceModel));
