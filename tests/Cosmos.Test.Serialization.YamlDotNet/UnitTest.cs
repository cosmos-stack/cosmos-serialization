...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToYamlDotNetBytes();
        var backs = bytes.FromYamlDotNetBytes<NiceModel>();
    ...
    public void NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = model.ToYamlDotNetBytes();
        var backs = (NiceModel)bytes.FromYamlDotNetBytes(typeof(NiceModel));
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToYamlDotNetStream();
        var stream2 = new MemoryStream();
        model.YamlDotNetPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.YamlDotNetPackBy(model);

        var back1 = stream1.FromYamlDotNetStream<NiceModel>();
        var back2 = stream2.FromYamlDotNetStream<NiceModel>();
        var back3 = stream3.FromYamlDotNetStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromYamlDotNetStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromYamlDotNetStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromYamlDotNetStream(typeof(NiceModel));
    ...
    public void NonGenericStringTest()
    {
        var model = CreateNiceModel();
        var json1 = model.ToYamlDotNet();
        var back1 = (NiceModel)json1.FromYamlDotNet(typeof(NiceModel));
