...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToZeroFormatterBytes();
        var backs = bytes.FromZeroFormatterBytes<NiceModel>();
    ...
    public void NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = model.ToZeroFormatterBytes();
        var backs = (NiceModel)bytes.FromZeroFormatterBytes(typeof(NiceModel));
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToZeroFormatterStream();
        var stream2 = new MemoryStream();
        model.ZeroFormatterPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.ZeroFormatterPackBy(model);

        var back1 = stream1.FromZeroFormatterStream<NiceModel>();
        var back2 = stream2.FromZeroFormatterStream<NiceModel>();
        var back3 = stream3.FromZeroFormatterStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromZeroFormatterStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromZeroFormatterStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromZeroFormatterStream(typeof(NiceModel));
