...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToMsgPackBytes();
        var backs = bytes.FromMsgPackBytes<NiceModel>();
    ...
    public void NonGenericBytesTest()
    {
        var model = CreateNiceModel();
        var bytes = model.ToMsgPackBytes();
        var backs = (NiceModel)bytes.FromMsgPackBytes(typeof(NiceModel));
    ...
    public void StreamTest()
    {
        ...
        model.MsgPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.MsgPackBy(model);

        var back1 = stream1.FromMsgPackStream<NiceModel>();
        var back2 = stream2.FromMsgPackStream<NiceModel>();
        var back3 = stream3.FromMsgPackStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromMsgPackStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromMsgPackStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromMsgPackStream(typeof(NiceModel));
