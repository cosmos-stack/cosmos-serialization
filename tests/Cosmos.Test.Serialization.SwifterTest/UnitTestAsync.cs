...
public class UnitTestAsync
{
    ...
    public async Task BytesTest()
    {
        ...
        var bytes = await model.ToSwifterJsonBytesAsync();
    ...
    {
        var model = CreateNiceModel();
        var stream1 = await model.ToSwifterJsonStreamAsync();
        var stream2 = new MemoryStream();
        await model.SwifterJsonPackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.SwifterJsonPackByAsync(model);

        var back1 = await stream1.FromSwifterJsonStreamAsync<NiceModel>();
        var back2 = await stream2.FromSwifterJsonStreamAsync<NiceModel>();
        var back3 = await stream3.FromSwifterJsonStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromSwifterJsonStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromSwifterJsonStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromSwifterJsonStreamAsync(typeof(NiceModel));
