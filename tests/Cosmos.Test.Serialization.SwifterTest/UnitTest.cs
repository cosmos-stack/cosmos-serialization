...
public class UnitTest
{
    ...
    public void BytesTest()
    {
        ...
        var bytes = model.ToSwifterJsonBytes();
    ...
    {
        var model = CreateNiceModel();
        var stream1 = model.ToSwifterJsonStream();
        var stream2 = new MemoryStream();
        model.SwifterJsonPackTo(stream2);
        var stream3 = new MemoryStream();
        stream3.SwifterJsonPackBy(model);

        var back1 = stream1.FromSwifterJsonStream<NiceModel>();
        var back2 = stream2.FromSwifterJsonStream<NiceModel>();
        var back3 = stream3.FromSwifterJsonStream<NiceModel>();
    ...
    public void NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)stream1.FromSwifterJsonStream(typeof(NiceModel));
        var back2 = (NiceModel)stream2.FromSwifterJsonStream(typeof(NiceModel));
        var back3 = (NiceModel)stream3.FromSwifterJsonStream(typeof(NiceModel));
