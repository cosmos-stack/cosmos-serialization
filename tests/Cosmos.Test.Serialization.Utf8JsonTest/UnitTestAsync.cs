...
public class UnitTestAsync
{
    ...
    {
        var model = CreateNiceModel();
        var stream1 = await model.ToUtf8JsonStreamAsync();
        var stream2 = new MemoryStream();
        await model.Utf8JsonPackToAsync(stream2);
        var stream3 = new MemoryStream();
        await stream3.Utf8JsonPackByAsync(model);

        var back1 = await stream1.FromUtf8JsonStreamAsync<NiceModel>();
        var back2 = await stream2.FromUtf8JsonStreamAsync<NiceModel>();
        var back3 = await stream3.FromUtf8JsonStreamAsync<NiceModel>();
    ...
    public async Task NonGenericStreamTest()
    {
        ...
        var back1 = (NiceModel)await stream1.FromUtf8JsonStreamAsync(typeof(NiceModel));
        var back2 = (NiceModel)await stream2.FromUtf8JsonStreamAsync(typeof(NiceModel));
        var back3 = (NiceModel)await stream3.FromUtf8JsonStreamAsync(typeof(NiceModel));
